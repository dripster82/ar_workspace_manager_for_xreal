...
enum HelpContent {
    ...
    struct Section: Identifiable {
        let id = UUID()
        let title: String
        let column: Int  // 0…2 = which of the three columns
    ...
    static let sections: [Section] = [
        ...
        Section(
            ...
            shortcuts: [
                ...
                Shortcut(keys: "⌃⌥↑ ⌃⌥↓", action: "Next / previous in the playlist"),
    ...
    /// Sections grouped by their target column (for the three-column layout).
