...
- **Cursor stuck / menu bar missing?** The glasses should be an **extended** display next to your
  ...
  The cursor no longer hard-locks when the glasses are the only display, but a fully headless Mac
  (Mac mini, only the glasses) still keeps the menu bar/Dock on the glasses' base desktop — running
  the glasses as an **extended** display alongside a Mac screen gives the best experience for now.
